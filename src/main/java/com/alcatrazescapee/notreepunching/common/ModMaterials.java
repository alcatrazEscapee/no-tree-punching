...
public class ModMaterials
{
    ...
    public static final ItemArmor.ArmorMaterial ARMOR_TIN = EnumHelper.addArmorMaterial(MOD_ID + ":tin", MOD_ID + ":tin", 3, new int[] {1, 2, 3, 1}, 4, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F);
