...
public class ModItems {
    ...
    private static ItemArmor.ArmorMaterial armorMaterialBronze = EnumHelper.addArmorMaterial(
            "NTP_BRONZE", NoTreePunching.MODID+":bronze", 15, new int[]{2,4,6,2}, 8, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F);
    private static ItemArmor.ArmorMaterial armorMaterialSteel = EnumHelper.addArmorMaterial(
            "NTP_STEEL", NoTreePunching.MODID+":steel", 50, new int[]{3,6,8,3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 4.0F);
