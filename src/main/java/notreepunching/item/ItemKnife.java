...
public class ItemKnife extends ItemTool {
    ...
    private static final Set<Block> EFFECTIVE_ON = Sets.newHashSet(Blocks.TALLGRASS,Blocks.DOUBLE_PLANT,Blocks.MELON_BLOCK,Blocks.PUMPKIN);
    public String name;

    public ItemKnife(Item.ToolMaterial material, String name){
        super(material.getAttackDamage()+2.0F,-1.8F,material,EFFECTIVE_ON);
