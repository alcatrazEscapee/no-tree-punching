...
*/
    ...
    private static void initCuttingRecipes(){
        ...
        //addCuttingRecipe(new ItemStack(Blocks.LEAVES2,6,0),new ItemStack(Blocks.SAPLING,1,4),new ItemStack(ModItems.grassFiber,2));
        //addCuttingRecipe(new ItemStack(Blocks.LEAVES2,6,1),new ItemStack(Blocks.SAPLING,1,5),new ItemStack(ModItems.grassFiber,2));
    ...
    private static void initCraftingRecipes(){
        ...
        for(int i=0; i<6;i++) {
            ...
            // This one needs to require a saw item, which requires its own ore dictionary entry
            //registerShapeless(new ItemStack(Blocks.PLANKS, 4, i), new ItemStack(Blocks.LOG, 1, 0), new ItemStack(Items.DIAMOND_AXE));
        }
