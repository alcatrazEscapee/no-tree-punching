...
public class TileEntityFirepit extends TileEntitySidedInventory implements ITickable, IHasFields {
    ...
    public TileEntityFirepit(){
        ...
        burnTicks = 300* ModConfig.Balance.FUEL_MULT;
            ...
            if(state.getValue(BURNING)){
                ...
                if(recipe != null){
                    ...
                    if(ItemUtil.canMergeStack(recipe.getOutput(),outStack)){
                        cookTimer++;
                        maxCookTimer = ModConfig.Balance.COOK_MULT;
                ...
                if(burnTicks <= 0){
                    ...
                    if(isItemValidFuel(is)){
                        burnTicks += TileEntityFurnace.getItemBurnTime(is) * ModConfig.Balance.FUEL_MULT;
                        maxBurnTicks = burnTicks;
